  ...
  try {
    ...
    const mappedArticles = articles.map(article => {
      ...
      const mapped = {
        ...
        image: (articleObj['🔗 imageUrl'] || articleObj.image || '/assets/default-article.jpg').replace('.jpg', '.webp'),
        img: (articleObj['🔗 imageUrl'] || articleObj.image || '/assets/default-article.jpg').replace('.jpg', '.webp'),
