  ...
  return (
    <Html lang="fr">
      <Head>
        ...
        {/* Polyfill ULTRA agressif pour requestIdleCallback - doit être chargé en premier */}
        <script
          dangerouslySetInnerHTML={{
            __html: `
              // Polyfill ULTRA agressif pour requestIdleCallback
              (function() {
                ...
                console.log('Safari polyfill loaded - requestIdleCallback available:', typeof window.requestIdleCallback);
              })();
