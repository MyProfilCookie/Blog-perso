...
export default function Document() {
  return (
    <Html lang="fr">
      <Head>
        {/* Polyfill ULTIME pour Safari - chargé AVANT tout */}
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              console.log('Safari polyfill ULTIME chargé - requestIdleCallback disponible:', typeof window.requestIdleCallback);
            `,
          }}
        />
