          ...
          <div className="max-w-7xl mx-auto text-center">
            <div className="flex justify-end mb-4">
              <Button
                ...
                variant="outline"
                size="sm"
                className="bg-white/20 hover:bg-white/30 border-white/30 text-white button-cls-optimized"
              >
              ...
              {mockData.matieres.map((matiere, index) => (
                <div key={index} className="mb-4">
                  ...
                  <Button
                    ...
                    className="w-full bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white button-cls-optimized"
                    size="sm"
                  >
                    Continuer
                  </Button>
              ...
              {mockData.exercices.map((exercice, index) => (
                <div key={index} className="mb-4">
                  ...
                  <Button
                    ...
                    className="w-full bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 text-white button-cls-optimized"
                    size="sm"
                  >
                    Voir les détails
                  </Button>
              ...
              {mockData.lecons.map((lecon, index) => (
                <div key={index} className="mb-4">
                  ...
                  <Button
                    ...
                    className="w-full bg-purple-600 hover:bg-purple-700 dark:bg-purple-700 dark:hover:bg-purple-800 text-white button-cls-optimized"
                    size="sm"
                  >
                    Reprendre
                  </Button>
