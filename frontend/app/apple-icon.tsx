    ...
    (
      ...
      >
        ...
        >
          ...
          />
          {/* Points décoratifs */}
          <circle cx="85" cy="50" r="5" fill="#e07856" />
          <circle cx="15" cy="50" r="4" fill="#e07856" opacity="0.6" />
          <circle cx="50" cy="13" r="4" fill="#e07856" />
          <circle cx="50" cy="87" r="4" fill="#e07856" opacity="0.6" />
        </svg>
      </div>
    ),
    {
