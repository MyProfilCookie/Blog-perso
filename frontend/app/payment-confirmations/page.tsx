...
//             <h1 className="mb-6 text-4xl font-bold text-center text-indigo-600">Confirmation de Commande</h1>

//             {/* Informations Client */}
//             <div className="p-6 bg-indigo-50 rounded-lg shadow-md">
//                 <h2 className="mb-4 text-xl font-semibold text-gray-800">Informations Client</h2>
...
//                 <h2 className="mb-4 text-xl font-semibold text-gray-800">Adresse de Livraison</h2>
//                 <p>
...
//             <div className="p-6 mt-6 bg-indigo-50 rounded-lg shadow-md">
//                 <h2 className="mb-4 text-xl font-semibold text-gray-800">Détails de la Commande</h2>
//                 <ul>
//                     {items.length > 0 ? (
//                         items.map((item: any) => (
        ...
        const fetchOrderData = async () => {
            try {
                ...
                if (response.status === 404) {
                    throw new Error("Commande non trouvée. Assurez-vous d'avoir passé une commande valide.");
                }
            ...
            <div className="p-6 mt-6 bg-indigo-50 rounded-lg shadow-md">
                ...
                <ul>
                    {items.length > 0 ? (
                        items.map((item: any) => (
                            <li key={item._id} className="mb-2">
                                <strong>{item.quantity}</strong> x {item.title || "Article"} - {item.price?.toFixed(2)} €
                            </li>
                        ))
                    ) : (
                        <li className="text-red-500">Aucun article trouvé dans la commande.</li>
