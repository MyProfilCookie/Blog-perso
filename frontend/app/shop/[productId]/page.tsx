...
import { ArrowLeft, ShoppingBag, Star, Package, ShieldCheck, TrendingUp } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-gray-600 dark:text-gray-400 text-sm">(4.8/5 - 127 avis)</span>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-6 mb-6">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">TVA incluse • Frais de livraison calculés à la caisse</p>
            </div>
            ...
            {product.features && product.features.length > 0 && (
              <div className="mb-6">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Caractéristiques</h2>
            ...
            {(product.weight || product.dimensions) && (
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 mb-6">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Informations techniques</h3>
                {product.weight && (
            ...
            <div className="space-y-3">
              ...
              {product.link && (
                ...
                >
                  <NextLink href={product.link} target="_blank" rel="noopener noreferrer">
                    Voir sur Amazon
                  </NextLink>
                </Button>
              )}
