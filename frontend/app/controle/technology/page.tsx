...
const TechnologyPage: React.FC = () => {
  ...
  const handleRating = (rating: "Facile" | "Moyen" | "Difficile") => {
    ...
    console.log(`Progression en technologie : ${rating}`);
  };
  ...
  return (
    ...
    >
      <h1 className="text-3xl font-bold mb-8 text-center">Technologie</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <ProgressTracker subject="Technologie" onRating={handleRating} />
      </div>
