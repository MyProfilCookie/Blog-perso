...
const HistoryPage: React.FC = () => {
  ...
  return (
    <div className="p-4 bg-gradient-to-br from-white to-amber-50 dark:from-gray-900 dark:to-gray-800 min-h-screen">
      ...
      >
        <select
          className="w-full sm:w-80 p-4 text-lg font-semibold rounded-2xl border border-amber-400 bg-amber-50 dark:bg-gray-900 shadow-md focus:ring-2 focus:ring-amber-500"
      ...
      <div className="flex justify-center my-4 gap-2">
        {Array.from({ length: totalPages }).map((_, idx) => (
          <button
            key={idx}
            className={`px-4 py-2 rounded-full font-semibold transition-transform transform border shadow-sm hover:scale-105 hover:bg-amber-200 ${
              currentPage === idx + 1
      ...
      {emoji && (
        <motion.div
          animate={{ opacity: 1, y: 0 }}
          className="fixed top-4 right-4 bg-white dark:bg-gray-800 p-5 text-lg rounded-xl shadow-xl border-2 border-amber-300 z-50 font-semibold text-amber-600 dark:text-amber-400"
          ...
          >
            <Card className="w-full border border-amber-200">
              <CardBody className="p-4">
                <h3 className="font-bold mb-3 text-lg sm:text-xl text-amber-700 dark:text-amber-300">
                ...
                {ex.options ? (
                  <select
                    className="w-full mb-2 p-4 text-base rounded-xl border border-amber-300 dark:bg-gray-700 font-medium shadow-md focus:ring-2 focus:ring-amber-400"
                ...
                <Button
                  className="w-full bg-gradient-to-r from-amber-500 to-orange-500 text-white font-bold py-2 rounded-xl hover:brightness-110 transition"
                  disabled={results[ex._id] !== undefined}
      ...
      {showResults && (
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 max-w-md w-full">
            <h2 className="text-2xl sm:text-3xl font-bold text-center text-amber-600 dark:text-amber-400 mb-4">
              Résultats {emoji}
            </h2>
            ...
            <Button
              className="w-full mt-6 bg-amber-500 text-white hover:bg-amber-600"
