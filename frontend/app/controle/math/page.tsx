...
const MathPage: React.FC = () => {
  ...
  const encouragementMessages = [
    "🔢 Tu es un vrai mathématicien !",
    "📐 Excellent calcul mental !",
    "📏 Continue d'explorer les mathématiques !",
    "📊 Tes connaissances mathématiques s'améliorent !",
    "🧮 Tu deviens un expert en maths !",
  ...
  return (
    <div className="p-4 bg-gradient-to-br from-white to-red-50 dark:from-gray-900 dark:to-gray-800 min-h-screen">
      ...
      >
        <select
          className="w-full sm:w-80 p-4 text-lg font-semibold rounded-2xl border border-red-400 bg-red-50 dark:bg-gray-900 shadow-md focus:ring-2 focus:ring-red-500"
      ...
      <div className="flex justify-center my-4 gap-2">
        {Array.from({ length: totalPages }).map((_, idx) => (
          <button
            key={idx}
            className={`px-4 py-2 rounded-full font-semibold transition-transform transform border shadow-sm hover:scale-105 hover:bg-red-200 ${
              currentPage === idx + 1
